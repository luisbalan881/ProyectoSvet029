        ...
        <body>
          <div class=" block block-themed  remove-margin-b">
            ...
            <div class="">
              ...
              <form class="js-validation-empleado-029-m form-horizontal push-10-t push-10" action="" method="" id="em_form">
                    ...
                    <div class="col-xs-3">
                        <div class="form-material">
                          ...
                          <div class="input-group has-personalizado">
                            ...
                            <input class="form-control altura valor_d"  type="text"  id="salario_base" name="salario_base" value="<?php echo $persona1['salario_base'] ?>" required>
                          </div>
                        </div>
                    </div>
            ...
            <div class="form-group">
                <div class="col-xs-3">
                    <div class="form-material">
                      ...
                      <div class="input-group has-personalizado">
                        <span class="input-group-addon" ><span class="fa fa-edit"></span></span>
                        <input class="form-control "  type="text"  id="contrato_num" name="contrato_num" value="<?php echo $persona['contrato_num'] ?>" required>
                      </div>
                    </div>
                </div>
                ...
                <div class="col-xs-3">
                    <div class="form-material">
                      ...
                      <div class="input-group has-personalizado">
                        ...
                        value = "<?php if(($persona['contrato_fecha'])=='0000-00-00'){ echo '';}
                        else

                        {echo fecha_dmy( $persona['contrato_fecha']); }?>">
                      </div>
                    </div>
                </div>
                ...
                <div class="col-xs-3">
                    <div class="form-material">
                      ...
                      <div class="input-group has-personalizado">
                        <span class="input-group-addon" ><span class="fa fa-edit"></span></span>
                        <input class="form-control "  type="text"  id="fianza" name="fianza" value="<?php echo $persona['fianza'] ?>" >
                      </div>
                    </div>
                </div>
                ...
                <div class="col-xs-3">
                    <div class="form-material">
                      ...
                      <div class="input-group has-personalizado">
                        <input class="form-control  datepicker js-datepicker"  type="text"  id="contrato_ini" name="contrato_ini" data-date-language="es-ES" data-date-days-of-week-disabled="0,6" data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy"
                        value = "<?php if(($persona['contrato_ini'])=='0000-00-00'){ echo '';}
                        else

                        {echo fecha_dmy( $persona['contrato_ini']); }?>">
                        <span class="input-group-addon" ><span class="">a</span></span>
                        <input class="form-control  datepicker js-datepicker"  type="text"  id="contrato_fin" name="contrato_fin" data-date-language="es-ES" data-date-days-of-week-disabled="0,6" data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy"
                        value = "<?php if(($persona['contrato_fin'])=='0000-00-00'){ echo '';}
                        else

                        {echo fecha_dmy( $persona['contrato_fin']); }?>">
                      </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-6 text-right">
                        ...
                        <div class="btn-group btn-group-sm" role="group">
                          ...
                          <div class="btn-group mr-2" role="group" aria-label="Second group">
                            ...
                            <button class="btn btn-secondary btn-sm" onclick="modificar_029(<?php echo $id ?>,<?php echo $c?>)"><i id="loading_me_029" style="display:none;" class="fa fa-refresh fa-spin"></i> Guardar</button>
                          <?php }else{
