...
class CNumeroaLetra{
     ...
     *                              moneda ej: cuatrocientos Quet / cuatrocientas pesetas
    ...
    function setIsMoneda($mon){
        $this->is_moneda=(int)$mon;
    }
    ...
    function letra(){
        ...
        if(strlen($cnumero)>15){
            ...
            if($this->is_moneda){//es un monto en moneda
                if($this->mayusculas){//mayusculas
                    $texto=strtoupper($this->prefijo.$texto." ".$this->moneda." ".$pesos. " ".substr($cnumero,-2)."/100 ".$this->sufijo);
                }else{//minusculas
            ...
            {
                if($this->mayusculas){//mayusculas
                    $texto=strtoupper($this->prefijo.$texto.$this->sufijo);
                }else{//minusculas
                    $texto=strtolower($this->prefijo.$texto.$this->sufijo);
                }
            }
        }
        return $texto;
