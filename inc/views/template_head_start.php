...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo $one->assets_folder; ?>/img/favicons/favicon.png" type="image/x-icon">
        ...
        <link href="https://fonts.googleapis.com/css?family=Dhurjati|Londrina+Shadow|Suravaram|Timmana" rel="stylesheet">
