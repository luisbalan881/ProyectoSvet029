                     ...
                     <?php
                       ...
                       foreach ($nombramientos as $nombramiento){
                         //foreach ($personas as $persona){
                           // if($persona['ext_id'] > 0 && $nombramiento['user_status'] == 1){
                                ...
                                echo '<td >'.$nombramiento['user_nm1'].' '.$nombramiento['user_ap1'].' Nombramiento:'.($nombramiento['cod_nombramiento']).'</td>';
                       ...
                       //     echo '<span data-toggle="tooltip" title="Revisar"><a class="btn btn-default" '.(($nombramiento['status'] == 1 )?' href="almacen/requisicion_impresion.php?id='.$nombramiento['id_nombramiento'].'" target="_blank" ':'href="#" disabled').'><i class="fa fa-print text-info"></i></a></span>';
                           ...
                           // if (permiso_perm(4) && usuarioPrivilegiado()->hasPrivilege('crearCupon') || usuarioPrivilege('Configuracion'))
                            //{
                            echo '<button title="Imprimir admin" class="btn btn-personalizado outline" title="Descargar" ';
                             if ($nombramiento['status'] == 0 and $user_id == 193 )
                                {
                          ...
                          //  }
                                 echo '<span data-toggle="tooltip" title="Editar"><a class="btn btn-default"  title="Editar"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/solicitar_viaticos_1.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-pencil text-warning"></i></a></span>';
