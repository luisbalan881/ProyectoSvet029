<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        ...
        <head>
            ...
            <script src="assets/js/pages/solicitud_form_validate_liquidacion_ampliacion.js"></script>
...
<input class="form-control input-sm" type="number" id="dest" value="<?php echo $bitacora['tdesayunos']; ?>"> 
...
<input class="form-control input-sm" type="number" id="almt" value="<?php echo $bitacora['talmuerzos']; ?>"> 
...
<input class="form-control input-sm" type="number" id="cent" value="<?php echo $bitacora['tcenas']; ?>">
...
<input class="form-control input-sm" type="number" id="host" value="<?php echo $bitacora['thospedaje']; ?>"> 
...
<input class="form-control input-sm" type="text" SIZE=10 id="ampliacion1" value="<?php echo $bitacora['ampliacion_cantidad']; ?>">  

                    </div>
                                            
                      <label for="user_mail">Amplición </label>
                  </div>
                </div>
...
<input class="form-control input-sm" type="text" SIZE=10 id="ampliacion2" value="<?php echo $bitacora['ampliacion_tiempo']; ?>">  

                    </div>
                                            
                      <label for="user_mail">dias </label>
                  </div>
                </div>
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Formulario de Liquidación <span> Instrucciones generales: 1) Llenar los campos según lo facturado No sobrepasando los valores limites permitidos.  2) En caso de No utilizar algún campo, colocar un  cero "0" y no dejarlo en vacio.  3)Llenar los campos de detalle de comisión 4) Antes de dar click a LIQUIDAR verificar los valorles ingresados 5) En la casilla de ampliación ingresar el monto autorizado por ampliación 6) En la casilla de dias ingresar la cantidad en tiempo por ampliación 7) AL darle click a liquidar se genera automaticamente los formularios de Detalle de comisión y liquidación con ampliación. </span> </h1>
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              ...
                              <textarea class="form-control" id="objetivo" name="objetivo" maxlength="300" rows="2" required ><?php echo $bitacora['objetivod']; ?></textarea>
                            </div>
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="actividades" name="actividades" maxlength="850" rows="2" required ><?php echo $bitacora['actividades']; ?></textarea>
                            </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="logros" name="logros" maxlength="850" rows="2" required><?php echo $bitacora['logros']; ?></textarea>
                            </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario_ampliacion(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Liquidar</button>
                    </div>
                  </div>
