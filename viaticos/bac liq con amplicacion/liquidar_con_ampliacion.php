...
<input class="form-control input-sm" type="number" id="dest" value="0"> 
...
<input class="form-control input-sm" type="number" id="almt" value="0"> 
...
<input class="form-control input-sm" type="number" id="cent" value="0"> 
...
<input class="form-control input-sm" type="number" id="host" value="0"> 
...
<input class="form-control input-sm" type="text" SIZE=10 id="ampliacion1" value="0"> 
...
<input class="form-control input-sm" type="text" SIZE=10 id="ampliacion2" value="0"> 
                ...
                <h1>Formulario de Liquidación <span> Instrucciones generales: 1) Llenar los campos según lo facturado No sobrepasando los valores limites permitidos.  2) En caso de No utilizar algún campo, colocar un  cero "0" y no dejarlo en vacio.  3)Llenar los campos de detalle de comisión 4) Antes de dar click a LIQUIDAR verificar los valorles ingresados, ya que no se podra modificar 5) En la casilla de ampliación ingresar el monto autorizado por ampliación 6) En la casilla de dias ingresar la cantidad en tiempo por ampliación 7) AL darle click a liquidar se genera automaticamente los formularios de Detalle de comisión y liquidación con ampliación. </span> </h1>
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              ...
                              <textarea class="form-control" id="objetivo" name="objetivo" maxlength="300" rows="2" required ></textarea>
                            </div>
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="actividades" name="actividades" maxlength="850" rows="2" required ></textarea>
                            </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="logros" name="logros" maxlength="850" rows="2" required></textarea>
                            </div>
