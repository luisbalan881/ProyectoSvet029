    ...
    <script src="assets/js/plugins/jspdf/jspdf.js"></script>
            ...
            <script src="assets/js/plugins/jspdf/pdfFromHTML1.js"></script>
             ...
             <script src="assets/js/plugins/jspdf/pdfFromHTML31.js"></script>
              ...
              <script src="assets/js/plugins/jspdf/pdfLiquidacionAmpliacion.js"></script> 			  
              <script src="assets/js/plugins/jspdf/pdfFromHTML_liquidacion_ampliacion.js"></script>
         ...
         <div class="block-content">
             <table class="table table-bordered table-condensed table-striped js-dataTable-directorio" >
                     ...
                     <?php
                       ...
                       //     echo '<span data-toggle="tooltip" title="Revisar"><a class="btn btn-default" '.(($nombramiento['status'] == 1 )?' href="almacen/requisicion_impresion.php?id='.$nombramiento['id_nombramiento'].'" target="_blank" ':'href="#" disabled').'><i class="fa fa-print text-info"></i></a></span>';
                          ...
                          /*  echo '<button title="Imprimir Constancia" class="btn btn-personalizado outline" title="Descargar" ';
                             ...
                             */  
								echo '<button title="liquidación sin Anticipo" class="btn btn-personalizado outline" title="Descargar" ';
                             if ($nombramiento['status'] == 5)
                                {
							  ...
							  echo '<button title="Imprimir solicitud de amplición " class="btn btn-personalizado outline" title="Descargar" ';
				...
				//				
                                 ...
                                 echo '<button title="Imprimir Detalle Comision" class="btn btn-personalizado outline" title="Descargar" ';
                             if ($nombramiento['status'] == 3 or $nombramiento['status'] ==5 or $nombramiento['status'] >= 6 )
                                {
                                 echo 'onclick="HTMLtoPDF_detalle('.$nombramiento['id_nombramiento'].')"';
                             ...
                             if ($nombramiento['status'] >= 1  or $nombramiento['status'] == -1)
                                {
				  ...
				  if ($nombramiento['status'] ==4)
                                ...
                                if ($nombramiento['status'] == 0 ){
                                    echo '<span class="label label-warning"> Solicitud Anulada</span> </td>';
                                    //echo'-liquidado';
                                }  
                                  
                                else if ($nombramiento['status'] == 1 ){
                                  //  echo '<span class="label label-primary">Solicitud Enviada</span> </td>';
                                        echo '<span class="label label-primary">Solicitud Enviada <a class="btn btn-default"  title="Editar Nombramiento"  data-toggle="modal" data-target="#modal-remoto-lgg1" href="viaticos/solicitar_nombramiento_editable.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-pencil text-secundary"></i></a></span> </td>';
                                }
								 else if ($nombramiento['status'] == -1 ){
                                   echo '<span class="label label-info">Asignación de actividades <a class="btn btn-default"  title="Editar Nombramiento"  data-toggle="modal" data-target="#modal-remoto-lgg1" href="viaticos/solicitar_nombramiento_editable.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-pencil text-warning"></i></a> </span> </td>';
                                    //echo'-liquidado';
                                }
                                    ...
                                    echo '<span class="label label-success">Liquidado con ampliación<a class="btn btn-default"  title="Editar liquidacion con ampliacion"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/uptdate_liquidar_con_ampliacion.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-pencil text-warning"></i></a> </span> </td>';
                                    //echo'-liquidado';
                                }
                              
								else if ($nombramiento['status'] == 9 ){
                                    echo '<span class="label label-primary"> solicitud de ampliación enviada</span> </td>';
                                    //echo'-liquidado';
                                }
