    ...
    if (function_exists('login_check') && login_check() == true) :
        ...
        <head>
            ...
            <script src="assets/js/pages/solicitud_form_validate4.js"></script>
             <script src="assets/js/pages/solicitud_form_validate5.js"></script>
          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Confirmar Anulacion Formulario Anticipo</h1>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario5(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i>Confirmar Anulacion de formulario Anticipo</button>
                    </div>
                  </div>
