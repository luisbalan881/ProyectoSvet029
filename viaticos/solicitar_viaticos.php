          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Solicitar Viáticos<span>Formulario de solicitud de Viáticos</span></h1>
                      ...
                      <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
							  ...
							  <input class="js-datepicker form-control" type="text" id="soli_fecha" name="soli_fecha" data-date-language="es-ES"  data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy"  required>
                    ...
                    <div class="col-xs-5">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              ...
                              <textarea class="form-control" id="soli_lugar" name="soli_lugar" maxlength="90" rows="1"  required></textarea>
                            </div>
...
<div class="form-group">
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="objetivo" name="objetivo" maxlength="250" rows="2" required></textarea>
                            </div>
                 ...
                 <div class="form-group">
                      <div class="col-xs-12">
                          <div class="form-material">
                              ...
                              <label for="destinatarios">Tipo de viáticos(s)*</label>
                              <div class="input-group has-personalizado">
                                <span class="input-group-addon" ><span class="fa fa-bank"></span></span>
                                <select name="d_solicitantes" id="d_solicitantes"  multiple="multiple" data-placeholder="Seleccione uno o más opciones" class="chosen-select-width col-xs-12 form-control" multiple tabindex="6" required>
                                  <?php
                                  foreach ($tipo as $dept):
                                     // if ($dept['dep_status'] == 1){
                  ...
                  <div class="form-group">
                      <div class="col-xs-12">
                          <div class="form-material">
                              ...
                              <label for="destinatarios">Tipo de viáticos (s) dia 3, 4 y 5</label>
                              <div class="input-group has-personalizado">
                                <span class="input-group-addon" ><span class="fa fa-bank"></span></span>
                                <select name="d_solicitantes2" id="d_solicitantes2"  multiple="multiple" data-placeholder=" Seleccione uno o más opciones llenar si su comisión dura más de 2 días de lo contrario Omitirlo" class="chosen-select-width col-xs-12 form-control" multiple tabindex="6" >
                                  <?php
                                  foreach ($tipo2 as $dept):
                                     // if ($dept['dep_status'] == 1){
                                          echo '<option value="'.$dept["id_tipo"].'">'.$dept["descripcion"]."--dia-".$dept["dia"].'</option>';
                                     // }
                                  endforeach
                              ...
                              <script src="../assets/js/pages/solicitud_form_validate1.js" type="text/javascript"></script>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_solicitud1(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Crear Solicitud</button>
                    </div>
                  </div>
