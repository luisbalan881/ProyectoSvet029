     ...
     <div class="row items-push">
         <div class="col-sm-7">
             <h1 class="page-heading">
                 SOLICITUDES DE RECONOCIMIENTO DE GASTOS
             </h1>
         </div>
         <div class="col-sm-5 text-right hidden-xs">
             <ol class="breadcrumb push-10-t">
                 <li>SOLICITUDES DE RECONOCIMIENTO DE GASTOS</li>
                 <li><a class="link-effect" href="#">RECONOCIMIENTO DE GASTOS</a></li>
             </ol>
         </div>
     </div>
 </div>
                 ...
                 <tbody>
                     <?php
                       ...
                       //     echo '<span data-toggle="tooltip" title="Revisar"><a class="btn btn-default" '.(($nombramiento['status'] == 1 )?' href="almacen/requisicion_impresion.php?id='.$nombramiento['id_nombramiento'].'" target="_blank" ':'href="#" disabled').'><i class="fa fa-print text-info"></i></a></span>';
                         ...
                         /*    if ($nombramiento['status'] == 5 and $user_id == 177)
                                {
                           ...
                           /*  if ($nombramiento['status'] >= 2 and ($user_id == 9943 or $user_id==177) )
                                {
                             ...
                             if ($nombramiento['status'] >= 4 and ($user_id == 9943 or $user_id==177) )
                                {
                             ...
                             if ($nombramiento['status'] >= 6 and ($user_id == 9943 or $user_id==177))
                                {
                             ...
                             if ($nombramiento['status'] == 3 and ($user_id == 9943 or $user_id==177))
                                {
                          ...
                          //  }
                                  ...
                                  if ($nombramiento['status'] == 1 and ($user_id == 9943 or $user_id==177) )
                                {
                                 echo '<span data-toggle="tooltip" title="Autorizar"><a class="btn btn-default"  title="Se asignara un formulario"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/solicitar_viaticos_1.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-pencil text-warning"></i></a></span>';
                                  }
                                   ...
                                   if ($nombramiento['status'] == 2 and ($user_id == 9943 or $user_id==177) )
                                {
                                 echo '<span data-toggle="tooltip" title="Anular Anticipo"><a class="btn btn-default"  title="Anular Formulario Anticipo"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/sin_anticipio.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-eye text-info"></i></a></span>';
                                  ...
                                  //echo '<span data-toggle="tooltip" title="Anular"><a class="btn btn-default" ' . (($requisicion['req_status'] == 0) ? 'href="#" disabled' : ' data-toggle="modal" data-target="#modal-remoto" href="almacen/requisicion_anular.php?id='.$requisicion['req_id'].'"') . ' ><i class="fa fa-times text-danger"></i></a></span>';
								      ...
								      if ($nombramiento['status'] == 9 and ($user_id == 9943 or $user_id==177) )
                                {
                               ...
                               /*   if ($nombramiento['status'] == 2 )
                                {
                                 ...
                                 if ($nombramiento['status'] == 0 ){
                                    ...
                                    echo '<span class="label label-primary">Nueva solicitud</span> </td>';
                                    //echo'-liquidado';
                                }
                                    ...
                                    echo '<span class="label label-success">Liquidado Sin Anticipo</span> </td>';
                                    //echo'-liquidado';
                                }
                                    ...
                                    echo '<span class="label label-primary">Liquidado con ampliacion</span> </td>';
                                    //echo'-liquidado';
                                }
								 else if ($nombramiento['status'] == 9 ){
                                    echo '<span class="label label-primary">solicitud de  ampliación</span> </td>';
