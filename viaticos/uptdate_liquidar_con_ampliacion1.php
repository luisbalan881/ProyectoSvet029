...
<input class="form-control input-sm" type="text" SIZE=10 id="ampliacion2" value="<?php echo $bitacora['ampliacion_tiempo']; ?>">  
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Formulario de Liquidación <span> Instrucciones generales: 1) Llenar los campos según lo facturado o dejar los totales como se muestra en la pantalla.  2)Verificar los campos de detalle de comisión 3) Antes de dar click a LIQUIDAR verificar los valorles ingresados  4) En la casilla de ampliación ingresar el monto autorizado por ampliación 5) En la casilla de dias ingresar la cantidad en tiempo por ampliación 6) AL darle click a liquidar se genera automaticamente los formularios de Detalle de comisión y liquidación con ampliación. </span> </h1>
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="actividades" name="actividades" maxlength="1000" rows="2" required ><?php echo $bitacora['actividades']; ?></textarea>
                            </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario_ampliacion(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Modificar liquidación</button>
                    </div>
                  </div>
