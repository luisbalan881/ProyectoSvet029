<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        ...
        <head>
            ...
            <title>Liquidar ampliación</title>
            ...
            <script src="assets/js/pages/js_liquidar_ampliacion.js"></script>
                ...
                <h1>Formulario de Liquidación <span> Instrucciones generales: 1) Llenar los campos según lo facturado No sobrepasando los valores limites permitidos.  2) En caso de No utilizar algún campo, colocar un  cero "0" y no dejarlo en vacio.  3)Llenar los campos de detalle de comisión 4) Antes de dar click a LIQUIDAR verificar los valorles ingresados, ya que no se podra modificar 5) AL darle click a liquidar se genera automaticamente los formularios de Detalle de comisión y liquidación. </span> </h1>
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="actividades" name="actividades" maxlength="1000" rows="2" required ></textarea>
                            </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario2(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Liquidar con ampliación</button>
                    </div>
                  </div>
