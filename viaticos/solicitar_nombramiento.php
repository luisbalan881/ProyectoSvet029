<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        ...
        <head>
            ...
            <script src="assets/js/pages/solicitud_form_nonbramiento.js"></script>
        ...
        <body>
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Crear nombramiento<span>Formulario de creación de nombramiento</span></h1>
                 ...
                 <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              ...
                              <input class="form-control"    id="hora1" name="hora1" required>
                            </div>
					  ...
					  <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"    id="hora2" name="hora2" required>
                            </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="objetivo" name="objetivo" maxlength="225" rows="2" required></textarea>
                            </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">
                        <button id="boton_s_t" class="btn btn-sm btn-primary btn-block" onclick="add_solicitudNom(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Crear Nombramiento</button>
                    </div>
                  </div>
          ...
          <script>
              ...
              $('#hora1').timepicki();  //pendientes1
			    $('#hora2').timepicki();  //pendientes1
