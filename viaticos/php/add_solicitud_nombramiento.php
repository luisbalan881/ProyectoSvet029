...
$sql = "INSERT INTO vs_nombramiento (cod_nombramiento,id_funcionario,id_funcionario2,fecha_inicio,fecha_fin,lugar,objetivo,contador,dep_f1,status,hora_inicio,hora_fin) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";

$q = $pdo->prepare($sql);
$q->execute(array($codigo5,$id,$enc,$date1,$date2,$lugares,$objetivos,$con1,$departamento,$status,$hora1,$hora2));
$Id = $pdo->lastInsertId();
Database::disconnect();
