<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        ...
        <head>
			...
			<script src="assets/js/pages/solicitud_form_validate33.js"></script>
            ...
            <script src="assets/js/plugins/jspdf/pdfFromHTML1.js"></script>
             ...
             <script src="assets/js/plugins/jspdf/pdfFromHTML33.js"></script>
...
<input class="form-control input-sm" type="number" id="host" value="0"> 
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Formulario de Liquidación <span> Instrucciones generales: 1) Llenar los campos según lo facturado No sobrepasando los valores limites permitidos.  2) En caso de No utilizar algún campo, colocar un  cero "0" y no dejarlo en vacio.  3)Llenar los campos de detalle de comisión 4) Antes de dar click a LIQUIDAR verificar los valorles ingresados, ya que no se podra modificar 5) AL darle click a liquidar se genera automaticamente los formularios de Detalle de comisión y liquidación. </span> </h1>
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              ...
                              <textarea class="form-control" id="objetivo" name="objetivo" maxlength="200" rows="2" required ></textarea>
                            </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario22(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Liquidar</button>
                    </div>
                  </div>
