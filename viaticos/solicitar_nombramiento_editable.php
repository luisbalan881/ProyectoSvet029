<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        if ($u->hasPrivilege('crearSolicitudTransporte') ) :
			...
			//$bitacora =detallenombramieto_info($id2);////
   ...
   if ( !empty($_GET['id'])) {
        ...
        <head>
            ...
            <script src="assets/js/pages/solicitud_form_nonbramiento_editable.js"></script>
          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Modificar nombramiento<span>Formulario de modificación de nombramiento</span></h1>
                      ...
                      <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              ...
                              <input class="js-datepicker form-control" type="text" id="soli_fecha" name="soli_fecha" data-date-language="es-ES" data-date-days-of-week-disabled="0,7"  data-provide="datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd"   value=" <?php echo $bitacora['fecha_inicio']; ?>">
                            </div>
                       ...
                       <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-calendar-check-o"></span></span>
                              <input class="js-datepicker form-control" type="text" id="soli_fecha2" name="soli_fecha2" data-date-language="es-ES" data-date-days-of-week-disabled="0,7" data-provide="datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd"   value=" <?php echo $bitacora['fecha_fin']; ?>">
                            </div>
                    ...
                    <div class="col-xs-5">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              ...
                              <textarea class="form-control" id="soli_lugar" name="soli_lugar" maxlength="90" rows="1"  required> <?php echo $bitacora['lugar']; ?></textarea>
				...
				<div class="form-group">
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="objetivo" name="objetivo" maxlength="225" rows="2" required > <?php echo $bitacora['objetivo']; ?> </textarea>
                            </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">
                        <button id="boton_s_t" class="btn btn-sm btn-primary btn-block" onclick="add_solicitudNE(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Cambiar Nombramiento</button>
                    </div>
                  </div>
