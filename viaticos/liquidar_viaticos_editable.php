<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        ...
        <head>
            ...
            <title>Solicitar Viaticos</title>
...
<input class="form-control input-sm" type="text" SIZE=10 id="des5"   onChange="validarpordia5(this.value);"  value="0">
 ...
 <input class="form-control input-sm" type="text" id="dest" onChange="validarTotales(this.value);"  value="<?php echo $bitacora['tdesayunos']; ?>">    
...
<input class="form-control input-sm" type="text" SIZE=10 id="alm5"  onChange="validarpordia5(this.value);"  value="0">
 ...
 <input class="form-control input-sm" type="text" id="almt" onChange="validarTotales(this.value);" value="<?php echo $bitacora['talmuerzos']; ?>">   
...
<input class="form-control input-sm" type="text" id="cent" onChange="validarTotales(this.value);" value="<?php echo $bitacora['tcenas']; ?>"> 
...
<input class="form-control input-sm" type="text"  id="host"  onChange="validarTotales(this.value);" value="<?php echo $bitacora['thospedaje']; ?>"> 
...
<input class="form-control input-sm" type="number" id="totalgt"  readonly> 
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Formulario de Liquidación <span> Instrucciones generales: 1) Llenar los campos según lo facturado o dejar los totales como se muestra en la pantalla.  2)Verificar o editar los campos de detalle de comisión 3) Antes de dar click a LIQUIDAR verificar los valorles ingresados 4) AL darle click a liquidar se genera automaticamente los formularios de Detalle de comisión y liquidación en mis viaticos. </span> </h1>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario2(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Modificar Liquidación</button>
                    </div>
                  </div>
