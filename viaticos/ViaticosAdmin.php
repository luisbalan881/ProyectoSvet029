                       ...
                       //     echo '<span data-toggle="tooltip" title="Revisar"><a class="btn btn-default" '.(($nombramiento['status'] == 1 )?' href="almacen/requisicion_impresion.php?id='.$nombramiento['id_nombramiento'].'" target="_blank" ':'href="#" disabled').'><i class="fa fa-print text-info"></i></a></span>';
                           ...
                           // if (permiso_perm(4) && usuarioPrivilegiado()->hasPrivilege('crearCupon') || usuarioPrivilege('Configuracion'))
                            //{
                             ...
                             if ($nombramiento['status'] == 5 and ($user_id == 177 or $user_id==9971) )  // 177 usurio nitzia montejo  9966 alejandro quevedo
                                {
                                 echo 'onclick="HTMLtoPDFV13('.$nombramiento['id_nombramiento'].')"';
                          ...
                          /*  echo '<button title="Imprimir Constancia" class="btn btn-personalizado outline" title="Descargar" ';
                             ...
                             if ($nombramiento['status'] < 4 and ($user_id == 9971 or $user_id==177 or $user_id==1058) )  
                                {
                                ...
                                echo '><i class="fa fa-download"></i></button>';
								 ...
								 echo '<button title="imprimir Formulario Sin Anticipo" class="btn btn-personalizado outline" title="Descargar" ';
                             if (($nombramiento['status'] == 4 or $nombramiento['status'] == 5) and ($user_id == 9971 or $user_id==177) )
                                {
                                 echo 'onclick="HTMLtoPDFV111('.$nombramiento['id_nombramiento'].')"';
                             ...
                             if ($nombramiento['status'] == 3 and ($user_id == 9971 or $user_id==177))
                                {
                                ...
                                echo '<button title="Imprimir justificación" class="btn btn-personalizado outline" title="Descargar" ';
                             if ($nombramiento['status'] >= 6 and ($user_id == 9971 or $user_id==177))
                                {
                                 echo 'onclick="HTMLtoPDFVjustificacion('.$nombramiento['id_nombramiento'].')"';
                                ...
                                echo '><i class="fa fa-download"></i></button>';
                                 ...
                                 echo '<button title="Imprimir liquidación con ampliación" class="btn btn-personalizado outline" title="Descargar" ';
                             if ($nombramiento['status'] >= 6 and ($user_id == 9971 or $user_id==177))
                                {
                                 echo 'onclick="pdfLiquidacionAmpliacion('.$nombramiento['id_nombramiento'].')"';
                          ...
                          //  }
                                  ...
                                  if ($nombramiento['status'] == 1 and ($user_id == 9971 or $user_id==177) )
                                {
                                 echo '<span data-toggle="tooltip" title="Autorizar"><a class="btn btn-default"  title="Se asignara un formulario"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/solicitar_viaticos_1.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-check-square" aria-hidden="true"></i></a></span>';
                                  }
								  
								  
								  
                                   if ($nombramiento['status'] == 2 and ($user_id == 9971 or $user_id==177) )
                                {
                                 echo '<span data-toggle="tooltip" title="Anular Anticipo"><a class="btn btn-default"  title="Anular Formulario Anticipo"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/sin_anticipio.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-times" aria-hidden="true"></i></a></span>';
                                  ...
                                  //echo '<span data-toggle="tooltip" title="Anular"><a class="btn btn-default" ' . (($requisicion['req_status'] == 0) ? 'href="#" disabled' : ' data-toggle="modal" data-target="#modal-remoto" href="almacen/requisicion_anular.php?id='.$requisicion['req_id'].'"') . ' ><i class="fa fa-times text-danger"></i></a></span>';
                                    ...
                                    if ($nombramiento['status'] == 9 and ($user_id == 9971 or $user_id==177) )
                                {
                                 echo '<span data-toggle="tooltip" title="Autorizar ampliacion"><a class="btn btn-default"  title="Autorizar ampliacion"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/autorizar_ampliacion.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-edit text-info"></i></a></span>';
                              ...
                              /*  else {
                               ...
                               /*   if ($nombramiento['status'] == 2 )
                                {
                                 echo '<span data-toggle="tooltip" title="Liquidar"><a class="btn btn-default"  title="Liquidar"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/solicitar_viaticos_2.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-pencil text-warning"></i></a></span>';
                                  }
                                else {
                                 ...
                                 if ($nombramiento['status'] == 0 ){
                                    ...
                                    echo '<span class="label label-warning">Nueva solicitud</span> </td>';
                                    //echo'-liquidado';
                                }
                                else if ($nombramiento['status'] == 2 ){
                                    echo '<span class="label label-success">Autorizado (a liquidar)</span> </td>';
                                    //echo'-liquidado';
                                }
                                else if ($nombramiento['status'] == 3 ){
                                    echo '<span class="label label-primary">Liquidado</span> </td>';
                                    //echo'-liquidado';
                                }
                                    ...
                                    echo '<span class="label label-primary">Liquidado Sin Anticipo</span> </td>';
                                    //echo'-liquidado';
                                }
                                else if ($nombramiento['status'] == 6 ){
                                    echo '<span class="label label-success">Autorizado con ampliación (a liquidar)</span> </td>';
                                    //echo'-liquidado';
                                }
                                 
                                else if ($nombramiento['status'] == 7 ){
                                    echo '<span class="label label-primary">Liquidado con ampliación</span> </td>';
                                    //echo'-liquidado';
                                }
                                else if ($nombramiento['status'] == 9 ){
                                    echo '<span class="label label-warning">solicitud de  ampliación</span> </td>';
                                    //echo'-nueva solicitud de ampliacion';
                                }
                            echo ' ';
                            echo '</div>';
                            echo '</td>';
