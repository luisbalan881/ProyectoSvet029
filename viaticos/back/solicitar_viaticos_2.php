<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        ...
        if ( null==$id2 ) {
          ...
          $dias = tipos_dias_laborales_suspencion($dias);
          echo $dias;
...
<input class="form-control input-sm" type="number" id="dest" value="0"> 
                      ...
                      <label for="user_mail">TOTAL 18</label>
                  </div>
