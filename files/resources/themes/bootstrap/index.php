...
<html>
    ...
    <body>
            ...
            <div class="content-boxed">
                ...
                <ol class="breadcrumb breadcrumb-arrow">
                    <?php foreach($breadcrumbs as $breadcrumb): ?>
                        ...
                        <?php else: ?>
                            <li><a href="<?php echo $breadcrumb['text']; ?>"><?php echo $breadcrumb['text']; ?></a></li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </ol>
        ...
        <div id="page-content" class="content-boxed">
            ...
            <div id="directory-list-header">
                <div class="row">
                    <div class="col-md-7 col-sm-6 col-xs-10">Archivo</div>
                    <div class="col-md-2 col-sm-2 col-xs-2 text-right">Tamaño</div>
                    <div class="col-md-3 col-sm-4 hidden-xs text-right">Modificado</div>
                </div>
            </div>
