    ...
    if (usuarioPrivilegiado()->hasPrivilege('modificarAlmacen')):
      ...
      <!DOCTYPE html>
        ...
        <head>
          ...
          <title>Congelar Requisición</title>
        </head>
        <body>
          <div class="block block-themed block-transparent remove-margin-b">
            <div class="block-header bg-primary">
                ...
                <h3 class="block-title">Congelar Requisición</h3>
            </div>
            <div class="block-content">
                  <form class="js-validation-requisicion form-horizontal push-10-t push-10" action="<?php echo htmlentities($_SERVER['REQUEST_URI']); ?>" method="POST">
                    ...
                    <div class="form-group">
                      <div class="col-xs-12">
                          <div class="form-material">
                              <textarea class="form-control" id="req_obs" name="req_obs" rows="3"><?php echo $requisicion['req_obs']; ?></textarea>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12 text-center">
                            <button class="btn btn-sm btn-primary btn-block" type="submit"><i class=""></i>Congelar Requisición</button>
                        </div>
                    </div>
                  </form>
              </div>
