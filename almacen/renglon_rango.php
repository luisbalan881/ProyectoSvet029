                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <div class="form-material">
                                <input class="form-control focus"  type="number"  id="renglon_inicio" name="renglon_inicio" required>
                                <label for="renglon_inicio">Renglón Inicio*</label>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-material">
                                <input class="form-control focus"  type="number"  id="renglon_fin" name="renglon_fin" required>
                                <label for="renglon_fin">Renglón Final*</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
