 ...
 <div class="content content-boxed">
     ...
     <div class="block">
         <div class="block-header bg-gray-lighter">
           ...
           <h3 class="block-title">Listado de mis Registros</h3>
         </div>
             ...
             <table class="table table-bordered table-condensed table-striped js-dataTable-directorio" >
                 <thead>
                     <tr>
                         ...
                         <th class="hidden-xs text-center">color</th>
                               ...
                               // echo '<td class="hidden-xs" ><a href="mailto:'.$list_bitacora1['user_mail'].'">'.$list_bitacora1['user_mail'].'</td>';
                                 echo '<td class="hidden-xs">'.($list_bitacora1['nombre']).'</td>';
                                   ...
                                   echo '<td class="hidden-xs">'.($list_bitacora1['linea']).'</td>';
                                     echo '<td class="hidden-xs">'.($list_bitacora1['color']).'</td>';
                                //echo '<td >'.$list_bitacora1['user_nm1'].' '.$list_bitacora1['user_nm2'].' '.$list_bitacora1['user_ap1'].' '.$list_bitacora1['user_ap2'].'</td>';
                          ...
                          //  }
                              ...
                              //  if ($list_bitacora1['status'] == 0 ){
                                ...
                                //}  
                                 if ($list_bitacora1['status'] == 1 )
                                {
                                 echo '<span data-toggle="tooltip" title="registra KM final"><a class="btn btn-default"  title="Registrar Km final"  data-toggle="modal" data-target="#modal-remoto" href="combustible/reg_km_fin_user.php?id='.$list_bitacora1['id_bitacora'].'"><i class="fa fa-eye text-info"></i></a></span>';
                                  }
                                    ...
                                    echo '<span class="label label-primary">KM Registrado   <a class="btn btn-default"  title="Modificar destino"  data-toggle="modal" data-target="#modal-remoto" href="combustible/reg_km_fin_user_editable.php?id='.$list_bitacora1['id_bitacora'].'"><i class="fa fa-pencil text-warning"></i></a></span> </td>';
                                    //echo'-liquidado';
                                }
                               else if ($list_bitacora1['status'] == 3 ){
                                    echo '<span class="label label-primary">KM Registrado con destino modificado <a class="btn btn-default"  title="Modificar destino"  data-toggle="modal" data-target="#modal-remoto" href="combustible/reg_km_fin_user_editable.php?id='.$list_bitacora1['id_bitacora'].'"><i class="fa fa-pencil text-warning"></i></a></span> </td>';
                                    //echo'-liquidado';
                                }
                                 if ($list_bitacora1['status'] == 0 ){
                                    echo '<span class="label label-warning"> Anulado</span> </td>';
