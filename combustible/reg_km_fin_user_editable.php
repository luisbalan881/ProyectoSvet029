...
<link rel="stylesheet" type="text/css" href="../alertify/css/alertify.css">
	...
	<script src="../alertify/js/alertify.js"></script>
            ...
            <script src="assets/js/pages/solicitud_form_modificacion_destino.js"></script>
            ...
            <div class="">
             ...
             <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Formulario de modificacion de destino </h1>
 ...
 <div class="form-group">
   ...
   <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material">
                                <input class="form-control focus"  type="number"  id="km_fin" name="km_fin"  value="<?php echo $bitacora['km_final']; ?>" disabled>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario_km_fin2( <?php   echo $id2?>  )"><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> modificar destino final</button>
                    </div>
                  </div>
