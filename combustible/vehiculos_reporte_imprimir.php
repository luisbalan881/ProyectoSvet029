...
if (function_exists('login_check') && login_check()):
    ...
    ?>
        ...
        foreach($vehiculo_cupones as $cupon):
            ...
            $currentVehicle = $cupon['vehiculo_id'];
            $maxLineas--;
            if ($currentVehicle != $vehicle || $currentMonthYear != $monthYear || $currentUser != $user || $maxLineas == 0){
                if ($monthYear != null && $user != null && $vehicle != null){
                    echo '</tbody>';
                    echo '<tfoot>';
                    echo '<tr>';
                ...
                $vehiculo = Vehicle::getByID(usuarioPrivilegiado(),$currentVehicle);
