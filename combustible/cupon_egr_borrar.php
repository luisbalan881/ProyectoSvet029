...
if (function_exists('login_check') && login_check()):
    if (usuarioPrivilegiado()->hasPrivilege('crearCupon')):
        ...
        if ( !empty($_POST)) {
            CouponDispatch::update(usuarioPrivilegiado(),fecha_ymd($_POST['fecha']),$_POST['cupon_ing_id'],$_POST['vehiculo_id'],$_POST['conductor_id'],$_POST['usuario_id'],0,0,0,0,$_SESSION['user_id'],$id);
            header("Location: index.php?ref=_42");
        }
        ?>
        <!DOCTYPE html>
        ...
        <body>
          <div class="block block-themed block-transparent remove-margin-b">
            <div class="block-header bg-danger">
                ...
                <h3 class="block-title">Anular Cupón</h3>
            </div>
            <div class="block-content">
                <form class="js-validation-cupones-ing-update form-horizontal push-10-t push-10" action="<?php echo htmlentities($_SERVER['REQUEST_URI']); ?>" method="POST">
                    <div class="form-group">
                        <div class="col-xs-6">
                            <div class="form-material">
                                <input class="js-datepicker form-control" type="text" id="fecha" name="fecha" data-date-language="es-ES"  data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" value="<?php echo fecha_dmy($coupon['fecha']) ?>" readonly>
                                <label for="cdto_fecha">Fecha*</label>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-material">
                                <select class ="js-select2 form-control" name="cupon_ing_id" id="cupon_ing_id"  style="width: 100%;" data-placeholder="-- Seleccionar Cupón --" readonly>
                                    <?php
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material">
                                <select class ="js-select2 form-control" name="vehiculo_id" id="vehiculo_id"  style="width: 100%;" data-placeholder="-- Seleccionar Vehículo --" readonly>
                                    <option></option>
                                    <?php
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material">
                                <select class ="js-select2 form-control" name="conductor_id" id="conductor_id"  style="width: 100%;" data-placeholder="-- Seleccionar Conductor --" readonly>
                                    <option></option>
                                    <?php
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material">
                                <select class ="js-select2 form-control" name="usuario_id" id="usuario_id"  style="width: 100%;" data-placeholder="-- Seleccionar Usuario --" readonly>
                                    <option></option>
                                    <?php
                    ...
                    <div class="form-group">
                        <div class="col-xs-12 text-center">
                            <p class="text_center">¿Esta seguro de <span class="text-danger">ANULAR</span> el cupón? Esta acción no es reversible.</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-6 text-center">
                            <a href="?ref=_42"> <button type="button" class="btn btn-primary btn-block" >No, regresar</button></a>
                        </div>
                        <div class="col-xs-6 text-center">
