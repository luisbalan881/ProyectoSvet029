...
<link rel="stylesheet" type="text/css" href="../alertify/css/alertify.css">
	...
	<script src="../alertify/js/alertify.js"></script>
            ...
            <script src="assets/js/pages/solicitud_form_mantenimiento.js"></script>
            ...
            <div class="">
             ...
             <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Formulario control de mantenimiento vehiculo </h1>
 ...
 <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material">
                                <input class="form-control focus"  type="text"  id="vehiculo_id" name="vehiculo_id"  value="<?php echo $bitacora['vehiculo_id']; ?>" disabled>
                                <label for="vehiculo_id">Identificador*</label>
                            </div>
                        </div>
                    </div>
 ...
 <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material">
                                <input class="form-control focus"  type="text"  id="prov_nm" name="Destino"  value="<?php echo $bitacora['placa']; ?>" disabled>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material">
                                <textarea class="form-control" id="prov_desc" name="motivo" rows="3" disabled><?php echo $bitacora['nombre']; ?></textarea >
                                <label for="motivo">Vehiculo</label>
                            </div>
                        </div>
                    </div>
 <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material">
                                <input class="form-control focus"  type="number"  id="control_km_mantenimiento" name="control_km_mantenimiento"  value="<?php echo $bitacora['contador_km_mantenimiento']; ?>" disabled>
                                <label for="control_km_mantenimiento">contador de kilometraje recorridos*</label>
                            </div>
                        </div>
                    </div>
<div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material">
                                <input class="form-control focus"  type="text"  id="descripcion" name="descripcion">
                                <label for="descripcion">descripcion de mantenimiento</label>
                            </div>
                        </div>
                    </div>
                 ...
                 <?php $placa=$bitacora['vehiculo_id']; ?>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario_mantenimiento( <?php   echo $id2?> , <?php   echo $placa?> )"><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Registrar kilometraje final</button>
                    </div>
                  </div>
