<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        ...
        <body>
          ...
          <div class="block block-themed block-transparent remove-margin-b">
            <form class="js-validation-asignar-cupones form-horizontal push-10-t push-10">
              ...
              <?php if($carro['km_ini']==0.00 && $carro['km_fin']==0.00 && $carro['fecha_autorizado']!='0000-00-00' && permiso_perm(6) && usuarioPrivilegiado()->hasPrivilege('leerCupon') && $carro['e_sol']== 2)
              {
                ?>
                <div id="kilometrajes">
                </div>
        ...
        <?php
        if($carro['km_ini']==0.00 && $carro['km_fin']==0.00 && $carro['fecha_autorizado']!='0000-00-00' && permiso_perm(6) && usuarioPrivilegiado()->hasPrivilege('leerCupon')) {
          ?>
          <script>
