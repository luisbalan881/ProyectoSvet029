...
if (function_exists('login_check') && login_check()):
    if (usuarioPrivilegiado()->hasPrivilege('crearCupon')):
        ...
        if ( !empty($_POST)) {
            CouponApplication::update(usuarioPrivilegiado(),$_POST['cta_id'],fecha_ymd($_POST['fecha']),$_POST['fac_serie'],$_POST['fac_num'],$_POST['pedido_num'],$_POST['codigo'],$_POST['prov_id'],$_POST['comentario'],$_SESSION['user_id'],$id);
        ...
        <head>
            ...
            <title>Cupones Pedido Modificar</title>
        </head>
        <body>
          <div class="block block-themed block-transparent remove-margin-b">
            <div class="block-header bg-warning">
                ...
                <h3 class="block-title">Modificar Pedido de Cupones</h3>
            </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material">
                                ...
                                <label for="comentario">Comentario de Modificación</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
