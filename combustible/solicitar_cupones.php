...
<form method="POST" oninput="resultado.value=(((parseFloat(des.value)*2)+(parseFloat(interno.value)*parseFloat(dias2.value)))/parseFloat(rendimiento.value))*parseFloat(p_galon.value)">
<br>
 <br>    
...
<input class="form-control input-sm" type="number" id="des" value="0"> 

                    </div>
                                            
                      <label for="user_mail">Kilometraje de destino </label>
                  </div>
                </div>
...
<input class="form-control input-sm" type="number" id="interno" value="0"> 
      </div>
                                            
                      <label for="user_mail">Kilometraje Interno </label>
                  </div>
                </div>
...
<input class="form-control input-sm" type="number" id="dias2" value="0"> 
    </div>
...
<input class="form-control input-sm" type="number" id="rendimiento" value="0"> 
    </div>
                      ...
                      <label for="user_mail">Rendimineto</label>
                  </div>
                </div>
...
<input class="form-control input-sm" type="number" id="p_galon" value="0"> 
    </div>
                                            
                      <label for="user_mail">Precio de galon</label>
                  </div>
                </div>
...
<input class="form-control input-sm" id="res_calculo" name="resultado" for="valor4">
    </div>
                                            
                      <label for="user_mail">Resultado</label>
                  </div>
                </div>
