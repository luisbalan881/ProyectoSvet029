function add_formulario22(userid, dep, correlativo) {

		  let salida2 = parseFloat(document.getElementById('totalgt').value);
		  let salida = parseFloat(document.getElementById('total').value);
		 
		  if(salida2 > salida ){
             swal("error ", "la sumatoria de los valores sobrepasan al monto total de la solicitud de viaticos  " + salida , "error");
        ...
        dur_en.each(function ()
      {
         ...
         var year = (new Date).getFullYear();
          ...
          $.ajax({
            ...
            type: "POST",
            url: "viaticos/php/add_solicitud33.php",
                    ...
                    codigo= data;
                        ...
                        //  
                          ...
                          $.ajax({
                            ...
                            type: "POST",
                            url: "viaticos/php/add_solicitud_detalle111copia.php",
