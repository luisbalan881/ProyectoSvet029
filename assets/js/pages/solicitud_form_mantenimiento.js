function add_formulario_mantenimiento(correlativo, placa) {
  jQuery('.js-validation-solicitud').validate({
    ...
    //    var logros=$('#logros').val();
     //   var actividades=$('#actividades').val();
        ...
        var control_km_mantenimiento=$('#control_km_mantenimiento').val();
        ...
        dur_en.each(function ()
      {
         especificacion=$(this).val();
          ...
          $.ajax({
                           ...
                           type: "POST",
                            url: "combustible/php/add_Registro_mantenimiento.php",
                            data: {c:c, descripcion:descripcion, control_km_mantenimiento:control_km_mantenimiento,vehiculo_id:vehiculo_id}, //f de fecha y u de estado.
