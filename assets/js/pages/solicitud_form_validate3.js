                     ...
                     setTimeout(function(){
                                     ...
                                     setTimeout(function(){
                                                    ...
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      show_notificacion_success("modificado");
                                    ...
                                    setTimeout(function(){
                                     ...
                                     setTimeout(function(){
                                                    ...
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      ...
                                                      show_notificacion_success("Solicitudcccccc");
                                                  //get_horarios_usuario();
                               ...
                               /*   success:function(data){
                                    ...
                                    setTimeout(function(){
                                     ...
                                     setTimeout(function(){
                                                    ...
                                                    $('#loading').fadeOut("slow");
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      show_notificacion_success("Liquidados");
                                                  //get_horarios_usuario();
                                               //   win.close();
                                           }, 300);*/
                                    ...
                                    setTimeout(function(){
                                     ...
                                     setTimeout(function(){
                                                    ...
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      ...
                                                      show_notificacion_success("liquidación modificada");
													   location.reload();
