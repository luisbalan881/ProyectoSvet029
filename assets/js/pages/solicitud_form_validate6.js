function add_formulario6(userid, dep, correlativo) {
        ...
        dur_en.each(function ()
      {
         ...
         var year = (new Date).getFullYear();
          ...
          $.ajax({
            ...
            type: "POST",
            url: "viaticos/php/add_solicitud5_1.php",
                     ...
                     setTimeout(function(){
                                     ...
                                     setTimeout(function(){
                                                    ...
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      show_notificacion_success("Ampliacion aprobada");
                    ...
                    codigo= data;
                        ...
                        //  
                          ...
                          $.ajax({
                            ...
                            type: "POST",
                            url: "viaticos/php/add_solicitud55_1.php",
                            data: {codigo:c}, //f de fecha y u de estado.
                                  ...
                                  success:function(data){
                                    ...
                                    setTimeout(function(){
                                     ...
                                     setTimeout(function(){
                                                    ...
                                                    $('#loading1').fadeOut("slow");
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      show_notificacion_success("procesado");
                                                  //get_horarios_usuario();
                                           }, 30);
