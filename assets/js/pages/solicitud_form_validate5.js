function add_formulario5(userid, dep, correlativo) {
        ...
        dur_en.each(function ()
      {
         ...
         var year = (new Date).getFullYear();
          ...
          $.ajax({
            ...
            type: "POST",
            url: "viaticos/php/add_solicitud5.php",
                     ...
                     setTimeout(function(){
                                     ...
                                     setTimeout(function(){
                                                    ...
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      show_notificacion_success("formulario Anticipio Anulado");
                    ...
                    codigo= data;
                        ...
                        //  
                          ...
                          $.ajax({
                            ...
                            type: "POST",
                            url: "viaticos/php/add_solicitud55.php",
                            data: {codigo:c}, //f de fecha y u de estado.
                                  ...
                                  success:function(data){
                                    ...
                                    setTimeout(function(){
                                     ...
                                     setTimeout(function(){
                                                    ...
                                                    $('#loading1').fadeOut("slow");
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      show_notificacion_success("procesado anulado");
                                                  //get_horarios_usuario();
                                           }, 30);
