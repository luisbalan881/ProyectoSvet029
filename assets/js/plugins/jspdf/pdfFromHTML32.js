                  function HTMLtoPDFV12(solicitud){
	$.ajax({
    type: "POST",
                ...
                //doc.text(173, 97,  data.hosp);//tgas
                 ...
                 doc.text(173, 94,  data.Total);//tgas
                  doc.text(173, 140, data.Total);  //total
                   doc.text(173, 148,  data.reitegro);
                     doc.writeText(173, 155 ,'00.00');
		 ...
		 doc.text(31, 186, data.autorizado2);
                 doc.text(31, 216, data.puesto);
				  //doc.writeText(161, 220 ,'NIT:');
                   ...
                   doc.text(140, 231, data.autorizado);
