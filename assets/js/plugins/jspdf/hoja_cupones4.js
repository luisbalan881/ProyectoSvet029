function datos_hoja_cupones4(year,mes,solicitud_id,dep_id){
  ...
  $.ajax({
    ...
    beforeSend:function(){
          ...
          success:function(data){
            ...
            doc.setFontSize(14);
            doc.writeText(0, 58 ,'',{align:'center',width:215});
         ...
         //	doc.setFillColor(255, 255, 255);
          ...
          //  doc.writeText(0, 255 ,'_________________________',{align:'center',width:215});
              doc.writeText(0, 240 ,'Elaborado_________________________                         Vo. Bo _________________________',{align:'center',width:215});
           ...
           // doc.writeText(0, 275 ,'_________________________',{align:'center',width:215});
              doc.writeText(0, 258 ,'Nombre y Firma de quien recibe los cupones___________________________________________',{align:'center',width:215});
