                  function HTMLtoPDFV11(solicitud){
	$.ajax({
    type: "POST",
...
//destino
	...
	var doc = new jsPDF();
        ...
        var logo1 = new Image();
        logo1.src = 'assets/img/anticipo.jpeg';
	   ...
	   //doc.text(33, 50, 'BOLETA DE SOLICITUD Y AUTORIZACIÓN DE VEH�?CULO PARA COMISIONES');
		...
		// doc.text(55, 92, p_lineas1);
		 doc.text(40, 147, data.autorizado);
                 doc.text(40, 157, data.puesto2);
                  
                   doc.text(40, 193, data.autorizado2);
                    doc.text(40, 207, data.puesto);
                     doc.writeText(0, 222 ,'Guatemala,'+data.fechaf,{align:'center',width:190});
