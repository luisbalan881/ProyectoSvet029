                  function HTMLtoPDFV_liquiidacion_ampliacion(solicitud){
	$.ajax({
    type: "POST",
    url: "viaticos/php/hoja_liquidacion_ampliacion.php",
	   ...
	   //doc.text(33, 50, 'BOLETA DE SOLICITUD Y AUTORIZACIÓN DE VEH�?CULO PARA COMISIONES');
		...
		// doc.writeText(0, 65 ,'SOLICITUD DE VIATICOS 6',{align:'center',width:211});
		 doc.setFontSize("8");
                  ...
                  doc.writeText(174, 36 ,'No.');
                    ...
                    doc.text(175, 44, data.ampliacion);// linea a agregar a cantidad
                    
                     doc.writeText(49, 58 ,'SECRETARIA. CONTRA LA VIOLENCIA SEXUAL, EXPLOTACION Y TRATA DE PERSONAS');
            var p_lineas2 = doc.splitTextToSize(data.obj, 59);
		...
		// doc.text(25, 80, 'Nombramiento :');
		 ...
		 doc.text(76, 94, p_lineas5); 
                  ...
                  // doc.text(119, 95, data.Total2);
                    doc.text(119, 94, data.t_ampliacion);//
		...
		// var p_lineas1 = doc.splitTextToSize(data.departamentos, 115);
               ...
               // doc.text(173, 79,  data.desa);
                ...
                //doc.text(173, 97,  data.hosp);//tgas
                 ...
                 doc.text(173, 94,  data.tgas);

                  doc.text(173, 140, data.Total);  //total
                   //doc.text(173, 149,  data.reitegro);
                     //doc.writeText(173, 148 ,'00.00');
                       //doc.text(173, 156,  data.reitegro);
					   
					    if (data.reitegro>0){
						 
						 doc.text(173, 157,  data.reitegro);///	????????
						  doc.writeText(173, 152 ,'00.00'); // reitegro a la dep
                     }
					 else
						  doc.text(173, 152,  data.reitegro);////
					   
					   
                   doc.text(173, 163, data.tgas);  //destino2
                  //doc.text(193, 146, data.resu);
                  //resu
                  //
                   var a= data.ampliacion;
                  var b=a.toString(10);
		...
		// doc.text(55, 92, p_lineas1);
                ...
                //doc.text(173, 150, r);
		 doc.text(31, 186, data.autorizado2);
                 doc.text(31, 217, data.puesto);
				  //doc.writeText(161, 220 ,'NIT:');
                   doc.text(171, 217, data.nit);
                  
                  
                   doc.text(140, 233, data.autorizado);
                    doc.text(140, 239, data.puesto2);
                     doc.writeText(0, 172 ,'Guatemala,'+data.fechaf,{align:'center',width:190});
