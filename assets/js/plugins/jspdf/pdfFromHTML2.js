  ...
  dataType:'json',
	...
	var doc = new jsPDF();
	   ...
	   //doc.text(33, 50, 'BOLETA DE SOLICITUD Y AUTORIZACIÓN DE VEH�?CULO PARA COMISIONES');
		 ...
		 doc.writeText(0, 61 ,'SOLICITUD REQUERIMIENTO DE TRASLADO POR MOTIVO DE LOS SERVICIOS',{align:'center',width:211});
		 doc.setFontSize("11");
                 doc.text(25, 71, 'A Señor (a) Dirección Finaciera');
		 doc.setFontSize("10");
    ...
    // doc.text(178, 115, data.personas);
	 ...
	 doc.text(25, 132, 'Descricón de lo solicitado: ');
	// doc.setTextColor(68, 68, 68);
