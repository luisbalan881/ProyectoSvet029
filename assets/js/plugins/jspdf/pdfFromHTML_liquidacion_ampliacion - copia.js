	   ...
	   //doc.text(33, 50, 'BOLETA DE SOLICITUD Y AUTORIZACIÓN DE VEH�?CULO PARA COMISIONES');
		...
		// doc.writeText(0, 65 ,'SOLICITUD DE VIATICOS 6',{align:'center',width:211});
		 doc.setFontSize("10");
                 ...
                 // var n1 = parseInt(data.Total);
                    doc.text(175, 30, data.ampliacion);// linea a agregar a cantidad
                   //  doc.text(175, 30, n1);// linea a agregar a cantidad
		...
		// doc.text(25, 80, 'Nombramiento :');
		 ...
		 doc.text(69, 79, p_lineas5); 
                  ...
                  //dias solicitados + dias de ampliacion
                 
                 // var t1=  data.Total2;
                 // var t2= data.acantidad;
                 // var tdias= (t1 + t2);
                  
                   doc.text(104, 86, data.t_ampliacion);//
		...
		// var p_lineas1 = doc.splitTextToSize(data.departamentos, 115);
                doc.text(80, 215,  data.correlativo);  //correlativo
                ...
                doc.text(173, 97,  data.hosp);//tgas
                 ...
                 doc.text(173, 120,  data.tgas);
                  doc.text(173, 146, data.Total);  //total
                   doc.text(173, 157,  data.reitegro);
                     doc.writeText(173, 152 ,'00.00');
