<?php
          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Solicitar Transporte<span>Formulario para la solicitud de vehículo para comisiones</span></h1>
                      ...
                      <div class="col-xs-12">
                          <div class="form-material">
                              ...
                              <div class="input-group has-personalizado">
                                ...
                                <select name="d_solicitantes" id="d_solicitantes"  multiple="multiple" data-placeholder="Seleccione uno o mas Departamentos" class="chosen-select-width col-xs-12 form-control" multiple tabindex="6" required>
                                  <?php
                    ...
                    <div class="">
                      <div class="table-responsive">
                        ...
                        <table class="table" width="100%" id="crud_table">
                         <thead>
                           <th width="40%" style="border:1px solid transparent" >Destino (s)</th>
                           <th width="60%" style="border:1px solid transparent" >Motivo (s)</th>
                  ...
                  <div class="form-group">
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            <label for="soli_desc">Personas que van a la comisión (Campo obligatorio)</label>
                            <div class="input-group has-personalizado">
  ...
  <input id="serverDate" type="hidden" value="<?php echo date('d-m-Y')?>">

                  <div class="form-group">
                    <div class="col-sm-12 text-center">
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_solicitud(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Crear Solicitud</button>
                    </div>
